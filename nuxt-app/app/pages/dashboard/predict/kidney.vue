...
const handleSubmit = () => {
  console.log("Initiating Renal Neural Analysis...", form);
};
</script>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <button
            type="submit"
            class="w-full mt-4 bg-[var(--primary)] text-white py-5 rounded-2xl font-black text-xs tracking-[0.2em] uppercase hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-[var(--primary)]/20"
          >
            Run Renal Diagnostic &rarr;
          </button>
        </form>
      </section>
      ...
      <aside class="space-y-6">
        ...
        >
          <h3 class="text-sm font-black mb-6 flex items-center gap-2">
            <i class="fas fa-history text-[var(--primary)]"></i>
            Clinical Context
          </h3>
          <div class="space-y-3">
            <div
